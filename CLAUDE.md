...
- [ ] **Nettoyer ws2812.h** — Il me semble que des déclarations sont en trop et/ou pas utilisé.
- [ ] **Intégrer des tests onboard pour Flush audio sur triple-trigger ENABLE** — Voir faisabilité (au moins pour pinio car possibilité de les trigger par code).
